...
/**
 * Tests for mod/assign/submission/filero/locallib.php
 *
...
/**
 * Unit tests for mod/assign/submission/filero/locallib.php
 *
 * @copyright  2016 Cameron Ball
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class locallib_test extends advanced_testcase {
    ...
    public function test_submission_is_empty($data, $expected) {
        ...
        $assign = $this->create_instance($course, [
                'assignsubmission_filero_enabled' => 1,
                'assignsubmission_filero_maxfiles' => 12,
                'assignsubmission_filero_maxsizebytes' => 10,
        ]);
