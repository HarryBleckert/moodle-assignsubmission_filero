...
Feature: In an assignment, limit submittable file types
  ...
  Scenario: File types validation for an assignment
    Given the following "activities" exist:
      | activity | course | name                 | duedate    | assignsubmission_onlinetext_enabled | assignsubmission_filero_enabled | assignsubmission_filero_maxfiles | assignsubmission_filero_maxsizebytes |
  ...
  Scenario: Uploading permitted file types for an assignment
    Given the following "activities" exist:
      | activity | course | name                 | duedate    | assignsubmission_onlinetext_enabled | assignsubmission_filero_enabled | assignsubmission_filero_maxfiles | assignsubmission_filero_maxsizebytes | assignsubmission_filero_filetypes |
