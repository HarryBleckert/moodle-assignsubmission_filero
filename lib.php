...
/**
 * This file contains the moodle hooks for the submission filero plugin
 *
 ...
 */
function assignsubmission_filero_pluginfile($course,
        $cm,
        context $context,
        $filearea,
        $args,
    ...
    $fullpath = "/{$context->id}/assignsubmission_filero/$filearea/$itemid/$relativepath";
